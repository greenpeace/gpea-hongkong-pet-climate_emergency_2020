  ...
  <section class="climate px-4 py-4">
    <div class="row md:mb-8">
      ...
      <div class="col-xs-12 col-lg-6">
        <h2 class="text-green text text-xl font-bold">「我唔要咁嘅未來呀！」</h2>
        <p class="text">
          年僅11歲的香港氣候行動家Lance於綠色和平的宣傳片中發出呼喚，提醒更多人必需關注氣候危機，再不及時行動，極端氣候的惡果將會由下一代承受。只要你願意開始行動，就有多一分力量應對氣候危機的嚴峻威脅！
        </p>
      </div>
      <div class="p-1 col-xs-12 col-md-6 col-lg-3">
        <img
    ...
    <div class="row">
      <div class="mt-4 col-xs-12 col-lg-4">
        <p class="text">
          與此同時綠色和平跟年僅11歲的本地氣候行動者劉衍一(Lance)會有一連串合作，一起將氣候危機訊息傳開，希望感染更多個人、企業和團體，一起為氣候危機行動，壯大守護氣候聲勢，從而推動改變。
        </p>
        <p class="text"></p>
      </div>
      <div class="mt-4 p-1 col-xs-6 col-lg-4">
